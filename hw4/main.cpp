...
int main()
{
    ...
    glGenBuffers(1, &VBO); // sim

    glBindBuffer(GL_ARRAY_BUFFER, VBO); // sim
    glBufferData(GL_ARRAY_BUFFER, sizeof(vertices), vertices, GL_STATIC_DRAW); // sim

    glBindVertexArray(containerVAO); // sim
